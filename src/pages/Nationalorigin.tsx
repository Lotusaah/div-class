  ...
  const textObject = {
    ...
    steps: (<div>
      <ul className="list-disc pl-5">
        ...
        <li>If they respond with insults, then there is no hope and try to have her employer know to have a consequence.</li>
